...
function botonActaEntregaHtml(){
  ...
  if(state.actaEligiendoSaludo){
    ...
    <div class="card" style="background:#f3eefc;">
      ...
      <button class="btn btn-outline btn-sm" style="width:100%;margin-bottom:6px;" data-action="generarActaEntrega" data-saludo="doctora">🩺 Dra.</button>
  ...
  try{
    ...
    if(state.driveToken){
      ...
      try{
        ...
        const SALUDOS_PDF = { empresa: 'Señores', hombre: 'Señor', mujer: 'Señora', doctor: 'Doctor', doctora: 'Doctora' };
