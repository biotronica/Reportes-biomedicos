...
function botonActaEntregaHtml(){
  ...
  if(state.actaEligiendoSaludo){
    ...
    <div class="card" style="background:#f3eefc;">
      ...
      <button class="btn btn-outline btn-sm" style="width:100%;margin-bottom:6px;" data-action="generarActaEntrega" data-saludo="doctor">🩺 Dr.</button>
...
async function generarActaEntrega(saludoElegido){
  ...
  try{
    ...
    const SALUDOS = { empresa: 'Señores', hombre: 'Señor', mujer: 'Señora', doctor: 'Dr.' };
...
async function generarInformeOficial(id, folderId){
  ...
  try{
    ...
    // Los informes individuales solo van dentro de Reportes/Ramiro|Evelyn — la
    // carpeta "Entrega documentos" es exclusivamente para el acta de entrega.
